...
<head>
    ...
    <link rel="stylesheet" href="acookieaday/away.css">
...
<?php if(!empty(htmlspecialchars(!empty($_COOKIE["theme"])))){$tC = htmlspecialchars($_COOKIE["theme"]);}else{$tC='light';};if($tC == 'dark'){echo ('<body class="dark">');}else{echo ('<body>');};?>
    <div class="nav-id">
            <div class="nav-l-ip"><button>Support</button><button>Blog</button><button>Shop</button></div>
            <div class="nav-ex-d">
            ...
            <div class="nav-sub-l">
            <div class="nav-menu">
            <button id="menubtn" class="icon-menu"><img class="icon-sl-m-men m-sl" src="src/public/icon-menu-bl.png"></button>
    ...
    <div class="main-s-d">
        <div class="m-i-logo"><img class="default-o" src="src/public/logo-sm-bl.png"><img class="dark-o" src="src/public/logo-sm-w.png"></div>
        <div class="m-searchbar">    
            <form action="search">
                <div class="nav-in">
                    ...
                    <div class="nav-search-btn"><button class="sea-btn"><img class="nl-se" src="src/public/icon-sea-bl.png"></button></div></input>
                </div>
            </form>
    ...
    <div class="ft-im-d"><img src="src/public/ft-img-osty.png" alt=""></div>
    <?php require('footer.php'); ?>

<script src="src/scripts/script_a.js"></script>
<script src="src/scripts/header.js"></script>
<script src="acookieaday/thedoctor.js"></script>
<script src="acookieaday/keeps.js"></script>
</body>
</html>