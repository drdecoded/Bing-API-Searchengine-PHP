...
// $url = $endpoint.$query;
// $key = "ae86f249c7104a909fecdf4dc577c46d";
// $curl = curl_init();
...
if(!empty($json['suggestionGroups'][0]['searchSuggestions'][0]['displayText'])){
    ...
    for ($x = 0; $x < count($json['suggestionGroups'][0]['searchSuggestions']); $x++) {
        ...
        echo('<li id="sb-'.$x.'" class="display_box sb-link sb-content" onclick="location.href=\'news?q='.$obj2.'\'"><img class="default-o" src="src/public/icon-sea-bl.png"><img class="dark-o" src="src/public/icon-sea-w.png"><a class="an-link"><span>'.$obj.'</span></a></li>');
      }
    echo('</ul>');
};
?>
