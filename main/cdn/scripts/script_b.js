'use strict';
var qUrlD;
if($(location).attr('pathname').includes('search')){
    qUrlD = 'pas/xAS1snivn.php';
}else if($(location).attr('pathname').includes('images')){
    qUrlD = 'pas/xAS2snivn.php';
}else if($(location).attr('pathname').includes('videos')){
    qUrlD = 'pas/xAS3snivn.php';
}else if($(location).attr('pathname').includes('news')){
    qUrlD = 'pas/xAS4snivn.php';
}
$(document).ready(function(){
    ...
    $("#w-search").focusout(function() {
        window.displayBoxIndex = -1;
        $(".display_box").removeClass("display_box_hover");
        $('.txtdel').css({color:'white'});
        if (readCookie('theme') == 'dark'){
            $('.txtdel').css({color:'#3b3b3b'});
        }
      });
