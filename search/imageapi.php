...
// $endpoint = 'https://api.bing.microsoft.com/v7.0/images/search'; // checkcURLparam benötigt den endpoint außerhalb bzw. immer oberhalb -> flexibilität für andere Suchen
// $query = '?q=wallpaper';
// $url = $endpoint.$query;
// $key = "";
// //echo $url;
...
$output = file_get_contents('jsonfiles/imageTATTOO.json');
