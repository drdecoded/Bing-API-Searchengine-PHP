...
//  $endpoint = 'https://api.bing.microsoft.com/v7.0/search'; // checkcURLparam benötigt den endpoint außerhalb bzw. immer oberhalb -> flexibilität für andere Suchen
// $query = '?q=topnews';
// $url = $endpoint.$query;
// $key = "";
// //echo $url;
...
//     $endpoint2 = 'https://api.bing.microsoft.com/v7.0/entities'; // checkcURLparam benötigt den endpoint außerhalb bzw. immer oberhalb -> flexibilität für andere Suchen
//     $query2 = '?q=topnews';
//     $url2 = $endpoint2.$query2;
//     $key2 = "";
//     //echo $url2;
...
//         curl_close($curl2); 
    ...
    //file_put_contents('searchTEST.json', $output);
    //file_put_contents('entityTEST.json', $output2);
    $output2 = file_get_contents('jsonfiles/entityDEUTSCHLAND.json');
    $output = file_get_contents('jsonfiles/searchGG.json');
...
<?php require('header.php'); ?>
    ...
    <?php require('footer.php'); //include_once('../quby/callquby.php'); ?>
    <style>
        .home-btn{
