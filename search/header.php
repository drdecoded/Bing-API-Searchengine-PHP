    <div class="nav-header">
        ...
        <div class="nav-super">
            <div class="home"><a href="search.php?q=PLACEHOLDER"><button class="home-btn"><?php if($tC == 'dark'){echo ('<img class="icon-sl h-btn" src="src/public/icon-sea-w.png">');}else{echo ('<img class="icon-sl h-btn" src="src/public/icon-sea-bl.png">');};?><span>Web</span></button></a>
            </div>
            ...
            <div class="vid"><a href="videos.php"><button class="vid-btn"><?php if($tC == 'dark'){echo ('<img class="icon-sl v-btn" src="src/public/icon-play-w.png">');}else{echo ('<img class="icon-sl v-btn" src="src/public/icon-play-bl.png">');};?><span data-lang="ma-v">Videos</span></button></a>
            </div>
            <div class="news"><a href="news.php"><button class="news-btn"><?php if($tC == 'dark'){echo ('<img class="icon-sl n-btn" src="src/public/icon-news-w.png">');}else{echo ('<img class="icon-sl n-btn" src="src/public/icon-news-bl.png">');};?><span data-lang="ma-n">News</span></button></a>
            </div>
            <div class="maps"><a href="maps"><button class="maps-btn"><?php if($tC == 'dark'){echo ('<img class="icon-sl m-btn" src="src/public/icon-maps-w.png">');}else{echo ('<img class="icon-sl m-btn" src="src/public/icon-maps-bl.png">');};?><span>Maps</span></button></a>
            </div>
